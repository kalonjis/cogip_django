...
from office.views import HomeView, OfficeDetailView, OfficeUpdateView, OfficeDeleteView, OfficeCreateView, officeDetail
...
urlpatterns = [
    ...
    path('company/<str:slug>/',
         ...
         name='company-detail'),
    path('contact/<str:slug>/', officeDetail, name='contact-detail'),
    path('invoice/<str:pk>/',
